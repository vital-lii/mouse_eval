...
CREATE TABLE IF NOT EXISTS acupuncture_intervention (
    ...
    operator VARCHAR(50),
    weight DECIMAL(5,2),
    general_condition ENUM('good', 'normal', 'poor') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
    ...
    end_time TIME,
    recovery_quality ENUM('good', 'normal', 'poor') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
